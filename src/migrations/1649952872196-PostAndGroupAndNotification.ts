...
export class PostAndGroupAndNotification1649952872196 implements MigrationInterface {
    name = 'PostAndGroupAndNotification1649952872196'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "c_notification" ("id" SERIAL NOT NULL, "content" character varying(256) NOT NULL, "content_type" character varying(32) NOT NULL, "read_at" TIMESTAMP NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "user_id" integer, CONSTRAINT "PK_0416df0a1d01342409dc2112818" PRIMARY KEY ("id"))`);
